...
/**
 * Generated class for the ReportActivityplanPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-report-activityplan',
  templateUrl: 'report-activityplan.html',
})
export class ReportActivityplanPage {
  ...
  cetak(){
    ...
    const url = 'https://pm.inka.co.id/a/reportpdf/activityplan.php?project='+this.project+'&status='+this.FormCetakData.value.status;
