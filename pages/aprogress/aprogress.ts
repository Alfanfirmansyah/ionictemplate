...
@IonicPage()
@Component({
  selector: 'page-aprogress',
  templateUrl: 'aprogress.html',
})
export class AprogressPage {
  postDataPlan:any;
  Data_Plan:any;
  idprojectDelete:any;
...
datarencana(){
  this.common.presentLoading();
    this.GetIdplan={pm:this.pm,status:this.datao};    
...
search(){
  ...
  this.Getparam={pm:this.pm,status:this.datao,pic:this.coba};     
