...
@IonicPage()
@Component({
  selector: 'page-arencana',
  templateUrl: 'arencana.html',
})
export class ArencanaPage {
  postDataPlan:any;
  Data_Plan:any;
  idprojectDelete:any;
  public FormSearch:FormGroup;
  postDataProject:any;
  postDataProjectpm:any;
  Data_Project:any;
  Data_Projectpm:any;
  postDelete:any;
  status='rencana';
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public authService:AuthServiceProvider,
    ...
    const data = JSON.parse(localStorage.getItem('userData'));
      if(data.userData){
        ...
        this.role_user = data.userData.role_user;
      }else{
        this.userDetails="";
      }
...
getpicpm(){
  ...
  this.authService.postData(this.Getpm,'Data_User_Pm').then((result) => {
    this.postDataProjectpm = result;      
    if(this.postDataProjectpm.Data_User_Pm){
      this.Data_Projectpm=this.postDataProjectpm.Data_User_Pm;
...
search(){
  ...
  this.Getparam={pm:this.pm,status:this.status,pic:this.coba};     
